...
function CardOrderList(props) {
    ...
    return (
        <div className='mb-4'>
            <Card className='px-9 py-6  border-solid border-1 border-black' sx={{ display: 'flex' }}>
            ...
            <div className='flex justify-center mt-2 '>
                <div className='px-3 py-1 bg-[#d48026] text-white text-sm rounded cursor-pointer mx-2'>HUỶ ĐƠN</div>
                <div className='px-3 py-1 bg-[#5fd078] text-white text-sm rounded cursor-pointer mx-2'>XÁC NHẬN</div>
                <div className='px-3 py-1 bg-[#74BFCF] text-white text-sm rounded cursor-pointer mx-2'>ĐANG GIAO</div>
                <div className='px-3 py-1 bg-[#7589D0] text-white text-sm rounded cursor-pointer mx-2'>CHỜ LẤY HÀNG</div>
                <div className='px-3 py-1 bg-[#AE75D0] text-white text-sm rounded cursor-pointer mx-2'>ĐÃ GIAO</div>
            </div>
