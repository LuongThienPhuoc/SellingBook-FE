...
function NavigationMobile(props) {
    ...
    return (
        <div className='min:block 900px:hidden'>
            <div className='900px:hidden top-2/3 left-0 sm:block absolute hover:cursor-pointer' onClick={() => { isOpen(true) }}>
                <BiDotsVerticalRounded></BiDotsVerticalRounded>
            </div>
            {
                open ? (
                    <div onClick={(e) => { isOpen(false) }} className='fixed bg-[#0000006e] top-0 left-0 right-0 bottom-0'>
